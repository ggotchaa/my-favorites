...
const notAssignedTagsSlice = createSlice({
  name: "notAssignedTagsForWalkdownManagement",
  initialState: {
...
export const getFilterParams = (state) =>
  state.notAssignedTagsForWalkdownManagement.params;
export const getFilterByColumn = (state) =>
  state.notAssignedTagsForWalkdownManagement.filterByColumn.filterParams;
export const getFilterCriteria = (state) =>
  state.notAssignedTagsForWalkdownManagement.filterByColumn.filterCriteria;
export const getCurrentPage = (state) =>
  state.notAssignedTagsForWalkdownManagement.currentPage;
export const getFilteredUnitCodes = (state) =>
  state.notAssignedTagsForWalkdownManagement.filteredUnitCodes;
export const isAnyFilterApplied = (state) =>
  JSON.stringify(state.notAssignedTagsForWalkdownManagement.params) !==
