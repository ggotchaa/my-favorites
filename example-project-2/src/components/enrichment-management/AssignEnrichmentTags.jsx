...
import { setIsScheduledEquipmentsUpdated } from "../../store/slices/enrichment-management/schedulesSlice";
import { resetAllFilters } from "../../store/slices/enrichment-management/notAssignedTagsSlice";

import { NotScheduledEnrichmentTagsTable } from "./NotScheduledEnrichmentTagsTable";
import { useEnrichmentManagement } from "../../hooks/useEnrichmentManagement";
import { EnrichmentTagsSearchHeader } from "./EnrichmentTagsSearchHeader";

export const AssignEnrichmentTags = ({
  closeAssignTagModal,
  scheduleId,
  notAssignedTags,
  isLoading,
  ...
  const { addEquipmentTags } = useEnrichmentManagement();
  const debounceTimerRef = useRef(null);

  const localPayload = localStorage.getItem("assignEnrichmentTagPayload");
  ...
  return (
    <div
      ...
      data-testid="assign-enrichment-tags"
    >
      <div className="flex justify-between items-center">
        ...
        <IconButton
          ...
          data-testid="close-assign-tag-modal"
        >
          <CloseIcon fontSize="small" />
        </IconButton>
      </div>
      <div className="flex items-center gap-4 justify-between w-full">
        <EnrichmentTagsSearchHeader
          isLoading={isLoading}
          search={search}
          setSearch={setSearch}
        />
      ...
      {isLoading ? (
        ...
        <>
          <NotScheduledEnrichmentTagsTable
