...
export const NotScheduledEnrichmentTagsTable = ({
  selectedTags,
  setSelectedTags,
  notScheduled,
  pending,
  ...
  const { getEquipmentDataFilteredByColumn } = useEnrichmentManagement();
        ...
        <Table stickyHeader aria-labelledby="tableTitle" size="small">
          ...
          <TableBody>
            {notScheduled.map((row) => {
              return (
                <TableRow
                  data-testid={`table-row-${row.equipmentTag}`}
                      ...
                      <Fragment key={col.id}>
                        {col.id === "checkbox" ? (
                          <TableCell width={col.width}>
                            <Checkbox
                              data-testid={`checkbox-${row.equipmentTag}`}
