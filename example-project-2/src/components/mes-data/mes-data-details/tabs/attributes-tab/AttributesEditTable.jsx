...
import { setIsCharacteristicsUpdated } from "../../../../../store/slices/mes-data/characteristicsSlice";
import {
  getUserPolicyId,
  selectUserRole,
...
export const AttributesEditTable = ({
  ...
  const renderEditableValue = (row) => {
    if (
      ...
      return (
        <TextField
          data-testid={`attribute-input-${row.jdeAttrName}`}
          variant="outlined"
          size="small"
          defaultValue={row.walkdownValue}
          disabled={loading || isPending}
  ...
  return (
    <>
      ...
      <TableContainer data-testid="attributes-edit-table-container">
        <Table
        ...
        >
          <>
            <TableHead data-testid="attributes-edit-table-head">
              <TableRow>
