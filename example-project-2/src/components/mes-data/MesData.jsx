...
import { getColumns } from "../../store/slices/mes-data/columnsSlice";
...
import { MesDataFilters } from "./MesDataFilters";
import { MesDataTable } from "./MesDataTable";
import { FILENAME } from "../../constants/mes-data";
...
export const MesData = () => {
  ...
  const savedRowsPerPage = localStorage.getItem("mesRowsPerPage");
  ...
  return (
    <div
      data-testid="mes-data-container"
      className="flex flex-col gap-2 w-full min-w-[1200px]"
    >
      <HeaderWithActions
        data-testid="mes-data-header"
        title="MES data"
        actions={tableActions}
      />
      <MesDataTable
        data-testid="mes-data-table"
        rows={rows}
        loading={loading}
        columns={columns}
        totalRows={totalRows}
