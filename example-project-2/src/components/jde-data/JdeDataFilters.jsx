...
export const JdeDataFilters = ({ toggleFiltersDrawer }) => {
  ...
  return (
    <div
      ...
      data-testid="jde-filters-container"
    >
      <div
        className="bg-white pt-[24px] mr-[24px] fixed flex flex-col w-[310px] z-10"
        style={{ width: "-webkit-fill-available" }}
        data-testid="jde-filters-header-container"
      >
        <HeaderWithActions title="Columns" actions={drawerFilterActions} />
      ...
      <div className="mt-5 pt-12 pb-1" data-testid="jde-filters-content">
