  ...
  return (
    <>
      ...
      <TableContainer>
        ...
        >
          {loading ? (
            <TableLoader data-testid="attributes-table-loader" width={840} />
          ) : (
            <>
              {!rows.length && !loading && (
                <NoDataFoundInTable label="No details" colSpan={5} />
              )}
              <TableHead data-testid="attributes-table-header">
                <TableRow data-testid="attributes-table-header-row">
                  <TableCell></TableCell>
              ...
              <TableBody>
                {rows.map((row) => (
                  <TableRow
                    ...
                    data-testid={`attributes-table-row-${row.jdeAttrCode}`}
                  >
                    <TableCell
                      align="left"
                      width={200}
                      component="th"
                      scope="row"
                      data-testid={`attributes-table-row-cell-${row.jdeAttrCode}`}
                    >
                      <div className="flex flex-col">
                        <span
                          data-testid={`attributes-table-row-cell-${row.jdeAttrCode}-label`}
                    ...
                    <TableCell align="left" width={340}>
                      <div className="flex items-center gap-2">
                        <span
                          ...
                          data-testid={`attributes-table-row-cell-${row.jdeAttrCode}-jde-value`}
                        >
                          {displayJDEValue(row)}
                        </span>
                      </div>
                    ...
                    <TableCell align="left" width={340}>
                      <div className="flex flex-col">
                        <span
                          className="text-sm leading-4 text-black/[0.87] font-roboto"
                          data-testid={`attributes-table-row-cell-${row.jdeAttrCode}-mes-value`}
                        >
                          {displayMESValue(row)}
                        </span>
                      </div>
                    ...
                    <TableCell
                      align="left"
                      width={250}
                      data-testid={`attributes-table-row-cell-${row.jdeAttrCode}-status`}
                    >
                    ...
                    <TableCell
                      align="left"
                      width={250}
                      data-testid={`attributes-table-row-cell-${row.jdeAttrCode}-comments`}
                    >
