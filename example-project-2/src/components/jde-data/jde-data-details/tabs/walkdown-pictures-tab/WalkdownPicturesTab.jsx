...
import { setIsWalkdownPicturesUpdated } from "../../../../../store/slices/jde-data/characteristicsSlice";
  ...
  return (
    <>
      <Paper
        ...
        data-testid="walkdown-pictures-tab"
      >
        ...
        <div
          ...
          className="flex flex-auto flex-wrap gap-4 p-4"
        >
          {loading ? (
            <div
            ...
            <>
              {!images.length ? (
                ...
                <>
                  ...
                  />
                  {canAddPhoto && renderAddPhotoButton()}
                </>
              )}
            </>
          )}
