...
import { ArJdeInvoiceFormGroup } from "../ArJdeInvoiceFormGroup";
...
export class ArJdeInvoiceFormGroupCreator extends JdeInvoiceFormGroupCreatorBase<JdeArInvoiceDto> {

    private instance: ArJdeInvoiceFormGroup;
    ...
    public createJdeInvoiceFormGroup(): IInvoiceFormGroupSetable<JdeArInvoiceDto> {
        ...
        this.instance =  new ArJdeInvoiceFormGroup(this.invoiceProductFormService, this._formGroup);
